<?php
    ...
    abstract class Manager{
        ...
        /**
         * Performs an 'INSERT INTO' query based on $data.
         *
         * @param  mixed $data Data of the new record.
